...
dataset.casia.dataset_path = '../datasets/faces_CASIA_112x112/faces_webface_112x112'
dataset.casia.num_classes = 10572
dataset.casia.image_shape = (112, 112, 3)
dataset.casia.val_targets = ['lfw', 'ytf']#['calfw', 'cfp_fp', 'agedb_30', 'cfp_ff', 'cplfw', 'lfw']

dataset.glint = edict()
dataset.glint.dataset = 'glint'
# '/opt/hard/javad/face/data/faces_glint'
dataset.glint.dataset_path = '/home/javad/datasets'
...
dataset.vox = edict()
dataset.vox.dataset = 'vox'
dataset.vox.dataset_path = '../datasets/vox/'
dataset.vox.num_classes = 4417
dataset.vox.image_shape = (112, 112, 3)
dataset.vox.val_targets = ['lfw', 'ytf']

dataset.test = edict()
dataset.test.dataset = 'test'
dataset.test.dataset_path = '../datasets/test/'
dataset.test.num_classes = 4
dataset.test.image_shape = (112, 112, 3)
dataset.test.val_targets = ['lfw', 'ytf']
...
# default network
default.network = 'm1'
default.pretrained = '/opt/hard/javad/results/recogniton_models/m1-softmax-casia-embedding/model'
default.pretrained_epoch = 1
# default dataset
default.dataset = 'vox'
default.loss = 'softmax'
default.frequent = 200
default.verbose = 3042
...
default.ckpt = 3
default.lr_steps = '4000,7000,8000'
